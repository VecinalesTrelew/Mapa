document.addEventListener('DOMContentLoaded', function() {
    ...
    const sedes = [
        ...
        {lat: -43.2411, lng: -65.3125, nombre: "San Martin", direccion: "Sin Sede", presidente: "Luis Loyola (Representación Provisoria)", estado: "Inactivo", color: "#f44336"},
        {lat: -43.2742, lng: -65.2576, nombre: "Los Pinos", direccion: "Sin Sede", presidente: "Daniela Ivanovich (Representación Provisoria)", estado: "Inactivo", color: "#f44336"},
