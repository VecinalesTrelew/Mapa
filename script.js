document.addEventListener('DOMContentLoaded', function() {
    ...
    const sedes = [
        ...
        {lat: -43.2732, lng: -65.3057, nombre: "Etchepare", direccion: "Scalabrini Ortiz 1753 (Domicilio Particular)", presidente: "Luis Treuquil", estado: "Activo", color: "#41ed00"},
        ...
        {lat: -43.2587, lng: -65.3119, nombre: "Santa Mónica", direccion: "Ameghino 671", presidente: "Gisell Aguirre", estado: "Activo", color: "#41ed00"},
        ...
        {lat: -43.2616, lng: -65.2896, nombre: "Villa Italia", direccion: "Maria Humpreys 202 (Domicilio Particular)", presidente: "Fernando Sanchez", estado: "Activo", color: "#41ed00"},
        ...
        {lat: -43.2493, lng: -65.3268, nombre: "Constitución", direccion: "Sin Sede", presidente: "Gastón Espiasse (Representación Provisoria)s", estado: "Utilizando una biblioteca provisoriamente", color: "#eaef00"},
        ...
        {lat: -43.2810, lng: -65.2712, nombre: "Los Paraísos", direccion: "Sin Sede", presidente: "Jorge Omar Subiela (Representación Provisoria)", estado: "Se encuentra activa pero sin talleres y demás actividades, por no tener espacio físico", color: "#eaef00"},
        ...
        {lat: -43.2411, lng: -65.3125, nombre: "San Martin", direccion: "Sin Sede", presidente: "Lucio Castillo (Otro)", estado: "Inactivo", color: "#f44336"},
        {lat: -43.2742, lng: -65.2576, nombre: "Los Pinos", direccion: "Sin Sede", presidente: "Sin Presidente (Con representante provisional: Daniela)", estado: "Inactivo", color: "#f44336"},
        {lat: -43.2579, lng: -65.3188, nombre: "Democracia", direccion: "Sin Sede", presidente: "Sin Presidente (Con representante provisional)", estado: "Inactivo", color: "#f44336"},
        ...
        {lat: -43.2516, lng: -65.3331, nombre: "Primera Junta", direccion: "Sin Sede", presidente: "Sin Presidente (Con representante provisional)", estado: "Inactivo", color: "#f44336"},
        ...
        {lat: -43.2653, lng: -65.3490, nombre: "Amaya", direccion: "Sin Sede", presidente: "Sin Presidente (Con representante provisional: Veronica)", estado: "Inactivo", color: "#f44336"},
        ...
        {lat: -43.2747, lng: -65.2832, nombre: "San Benito", direccion: "Sin Sede", presidente: "Margarita Barcela (Representación Provisional)", estado: "Inactivo", color: "#f44336"},
        {lat: -43.2698, lng: -65.2906, nombre: "Juan Manuel de Rosas", direccion: "Sin Sede", presidente: "Centeno Irupe (Representación Provisional)", estado: "Inactivo", color: "#f44336"},
        {lat: -43.2456, lng: -65.2981, nombre: "La Laguna", direccion: "Sin Sede", presidente: "Ricardo Miguens (Por problemas de salud, lo representa su hija: Antonella)", estado: "Inactivo", color: "#f44336"},
        {lat: -43.2835, lng: -65.2986, nombre: "Las Margaritas", direccion: "Sin Sede", presidente: "Juan José Truco (Representación Provisoria)", estado: "Inactivo", color: "#f44336"},
        ...
        {lat: -43.2774, lng: -65.2650, nombre: "Los Mimbres", direccion: "Sin Sede", presidente: "Maria Giselle Castro (Representación Provisoria)", estado: "Inactivo", color: "#f44336"},
        {lat: -43.2874, lng: -65.3324, nombre: "Las Lengas", direccion: "Sin Sede", presidente: "Jorge Evans (Representación Provisoria)", estado: "Inactivo", color: "#f44336"},  
