document.addEventListener('DOMContentLoaded', function() {
    ...
    const sedes = [
        ...
        {lat: -43.2493, lng: -65.3268, nombre: "Constitución", direccion: "Sin Sede", presidente: "Gastón Espiasse (Representación Provisoria)", estado: "Utilizando una biblioteca provisoriamente", color: "#eaef00"},
        ...
        {lat: -43.2579, lng: -65.3188, nombre: "Democracia", direccion: "Sin Sede", presidente: "Sin Presidente (Representación Provisional)", estado: "Inactivo", color: "#f44336"},
